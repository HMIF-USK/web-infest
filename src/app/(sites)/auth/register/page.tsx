...
function RegisterPageContent() {
  ...
  //           <h1
  //             className={`text-xl md:text-2xl font-bold text-neutral_01 mb-3 md:mb-4 ${dm_serif_display.className}`}
  //           >
  ...
  //               Akun Anda telah berhasil dibuat! Selamat datang di Informatics Festival XI 2025.
  //             </p>
  //             <div className="bg-blue-500/10 border border-blue-400/20 rounded-lg p-3 md:p-4">
  //               <p className="text-blue-300 text-xs md:text-sm">
  //                 📧 <strong>Penting:</strong> Silakan cek email Anda untuk link verifikasi. 
  //                 Anda perlu memverifikasi email sebelum dapat login.
  //               </p>
  //             </div>
